...
<head>
  ...
  <title>Etusivu - Linnakello Hämeenlinna</title>
</head>
<body>
      <!-- ylätunniste -->
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item"><a href="./index.html" class="nav-link text-white nav-active" aria-current="page">Etusivu</a></li>
    ...
    <section class="bg-black pb-5">
      ...
      <!-- javascript slider ja hamburger menu -->
